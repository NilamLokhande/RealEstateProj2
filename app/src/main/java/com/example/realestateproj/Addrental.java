...
public class Addrental extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Properties").child("Rentals");
...
//                                    String key = mDatabaseRef.child("Sales").push().getKey();
                                    ...
                                    modelRent imageUploadInfo = new modelRent(PropName, url, Description, Address, Price, countryCode, ownerName, ownerMail);
//                                     String ImageUploadId = mDatabaseRef.push().getKey();

                                    mDatabaseRef.child(ImageUploadId).setValue(imageUploadInfo);
                                    startActivity(new Intent(Addrental.this, home.class));
                                }
                            });
